    ...
    <div class="profile-content">
        <div class="container pb-5">
            ...
            <div class="row">
                ...
                {{-- Update status chipment --}}
                <div class="col-5 ml-auto">
                    <div class="card pt-3">
                        <div class="card-body ">
                           <h5 class="d-inline">Estatus del pedido: <strong>{{ $order->status_shipment }}</strong></h5>
                           <button type="button" class="btn btn-success btn-sm ml-5" data-toggle="modal" data-target="#shipment_status-{{$order->id}}">
                            Editar <span class="material-icons">edit</span>
                          </button>
                           
                           {{-- <a class="ml-2" type="button" data-toggle="tooltip" data-placement="top" title="Editar estatus del pedido" data-container="body"
